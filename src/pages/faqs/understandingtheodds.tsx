    ...
    return (
        <div className="relative h-80 w-full bg-white overflow-hidden">
            ...
            <div className='flex overflow-scroll scroll-smooth text-nowrap'>
                ...
                <Link to="/understandingtheodds"><h3 className='relative mt-5 ml-5 text-left text-sm text-dark font-medium'>Time Management & Self-Control</h3></Link>
                <div>
                ...
                <img src={line} className='relative mt-2 ml-5 h-1 w-22.5'/>
                </div>
