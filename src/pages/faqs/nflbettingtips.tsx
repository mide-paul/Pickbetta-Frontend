    ...
    return (
        <div className="relative h-80 w-full bg-white overflow-hidden">
            ...
            <div className='flex overflow-scroll scroll-smooth text-nowrap'>
                ...
                <div>
                <h3 className='relative mt-5 ml-5 text-left text-sm text-green font-extrabold'>NFL Betting Tips & Insight</h3>
            ...
            <div>
                <div ref={dropdownRef} className="relative mt-4 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpen(!open)} className='relative text-sm text-left font-bold'>Is betting on the favorite a good idea?</h3>
                ...
                <div ref={droptwoRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpentwo(!opentwo)} className='relative text-sm text-left font-bold'>What’s the best strategy for betting NFL games?</h3>
                ...
                <div ref={dropthreeRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenthree(!openthree)} className='relative text-sm text-left font-bold'>Should I bet on teams based on recent performance?</h3>
                ...
                <div ref={dropfourRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfour(!openfour)} className='relative text-sm text-left font-bold max-w-18'>How do injuries affect NFL betting?</h3>
                ...
                <div ref={dropfiveRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfive(!openfive)} className='relative text-sm text-left font-bold max-w-18'>How can I avoid losing money on NFL bets?</h3>
