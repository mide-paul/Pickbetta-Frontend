    ...
    return (
        <div className="relative h-80 w-full bg-white overflow-hidden">
            ...
            <div className='flex overflow-scroll scroll-smooth text-nowrap'>
                ...
                <div>
                <h3 className='relative mt-5 ml-5 text-left text-sm text-green font-extrabold'>Subscription & Pricing</h3>
                <img src={line} className='relative mt-2 ml-5 h-1 w-14'/>
                </div>
            ...
            <div>
                <div ref={dropdownRef} className="relative mt-4 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpen(!open)} className='relative text-sm text-left font-bold'>How much does PickBetta cost?</h3>
                ...
                <div ref={droptwoRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpentwo(!opentwo)} className='relative text-sm text-left font-bold'>Can I cancel my subscription anytime?</h3>
                ...
                <div ref={dropthreeRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenthree(!openthree)} className='relative text-sm text-left font-bold'>Is there a free trial for the Premium plan?</h3>
                ...
                <div ref={dropfourRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfour(!openfour)} className='relative text-sm text-left font-bold max-w-18'>What payment methods does PickBetta accept?</h3>
                ...
                <div ref={dropfiveRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfive(!openfive)} className='relative text-sm text-left font-bold max-w-18'>Are there discounts for annual subscriptions?</h3>
