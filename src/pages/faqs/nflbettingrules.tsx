    ...
    return (
        <div className="relative h-80 w-full bg-white overflow-hidden">
            ...
            <div className='flex overflow-scroll scroll-smooth text-nowrap'>
                ...
                <div>
                <h3 className='relative mt-5 ml-5 text-left text-sm text-green font-extrabold'>NFL Betting Rules & Terms</h3>
            ...
            <div>
                <div ref={dropdownRef} className="relative mt-4 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpen(!open)} className='relative text-sm text-left font-bold'>What is a “bad beat” in betting?</h3>
                ...
                <div ref={droptwoRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpentwo(!opentwo)} className='relative text-sm text-left font-bold'>What’s a “sharp” bettor?</h3>
                ...
                <div ref={dropthreeRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenthree(!openthree)} className='relative text-sm text-left font-bold'>What’s the difference between a “favorite” and an “underdog”?</h3>
                ...
                <div ref={dropfourRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfour(!openfour)} className='relative text-sm text-left font-bold max-w-18'>What does ATS mean?</h3>
                ...
                <div ref={dropfiveRef} className="relative mt-3 ml-5 p-2.5 w-20.4 border rounded">
                    <h3 onClick={() => setOpenfive(!openfive)} className='relative text-sm text-left font-bold max-w-18'>What does “juice” mean in betting?</h3>
