    ...
    return (
      <div className="home">
        ...
        <div>
          ...
          <p className="relative text-center text-base text-gray mt-4 ml-6.5 max-w-19.5">Experience the power of verified data- Try pickbetta free for one week. We’re so
        ...
        <div>
          <h3 className="relative ml-5.2 mt-8 text-xl font-extrabold text-left">Who We Are</h3>
          <p className="relative mt-4 ml-5.2 text-base text-gray text-left max-w-19.5">
        ...
        <div>
          <h3 className="relative ml-5.2 mt-8 text-xl font-extrabold text-left">Why Create PickBetta</h3>
          <p className="relative mt-4 ml-5.2 text-base text-gray text-left max-w-19.4">
