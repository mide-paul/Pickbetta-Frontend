...
export const Aboutus = () => {
  return (
    <div className='about'>
        <div>
        <h3 className="relative text-5xl text-dark font-extrabold mt-11 ml-0 max-w-26 text-center font-montserrat">About Us</h3>
        ...
        Sunday morning, I’d scramble, desperate for someone to advise me who to pick. I was chasing picks
        like a dog chasing its tail, never getting anywhere.
        </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left font-montserrat">
            ...
            handicappers are putting in the work? Are they really grinding out the research, or are they just
            recycling the same surface-level insights? And that’s when it hit me. Think about it—your "expert"
            handicapper, the one you faithfully pay for advice, is getting his insights from somewhere. Why
            not cut out the middleman and get the same, if not better, information yourself? Why am I betting
            my hard-earned dollars on someone else’s thinking, research, and work ethic when I could be making
            my own decisions with the right data?
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left font-montserrat">
            ...
            questionable advice and started trusting the numbers. But, there was a problem. The data I needed
            wasn’t just hard to find—it was practically hidden under lock and key. In the secretive world of
            sports data, the real insights, the ones that could actually give you an edge, are never sold to
            the public. Remember I said that! Good game is (usually) sold, not told, but in this (Mafioso-ran)
            business, they keep the best data for themselves. Instead of offering you the raw, actionable
            information, they sell you their "pick"—their interpretation of what the data says. In other words,
             they hide the data from you and make you pay for their version of it. That’s when the idea for
             PickBetta was born. I realized it was time to break the mold, to create a platform that puts the
             power back in your hands by giving you direct access to the same high-quality data the pros use,
             so you can make your own informed decisions.
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left max-w-20 font-montserrat">
            ...
            you do. And no one should have more control over your bets than you. The problem with paying for
            picks is that you’re betting on someone else’s judgment—and when they’re wrong, it’s your bankroll
            that takes the hit.
            </p>
        </div>
        <div>
            ...
            insights at your fingertips. Our goal is simple: to level the playing field by giving you access
            to the same data that the so-called experts use, so you can make informed, confident picks without
            relying on anyone else. With PickBetta, you’re not just buying into a newsletter—you’re investing
            in your ability to bet smarter and win more consistently.
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left max-w-20 font-montserrat">
            ...
            you to do. Stop chasing picks. Start chasing data. With PickBetta, you’re in
            control. You make the decisions. You create your own success. We’re just here to provide the tools
            to help you do it better. PickBetta was created out of necessity—my necessity, and likely yours
            too. I wanted a platform that I could trust implicitly, a place where the data was not just
            accurate but genuinely useful. I envisioned a site that would cut through the noise and give
            bettors like us exactly what we need to make smarter, more confident decisions.
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left max-w-21 font-montserrat">
        ...
        <div>
            ...
            platform built by a bettor, for bettors, with a singular focus on helping you bet better.
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left max-w-20 font-montserrat">
            ...
            day, betting should be about making informed choices—and we’re here to help you make the best ones
            possible.
            </p>
        </div>
        <div>
            ...
            <p className="relative ml-5 mt-6 text-gray text-xl font-normal text-left max-w-20 font-montserrat">
            ...
            Time-Sensitive Indicators: We offer
            insights that are timely and relevant to the current state of the season, adjusting for factors
            like playoff races, injuries, and weather.
            </p>
        </div>
        <div>
            <h3 className="relative ml-5 mt-6 text-xl font-extrabold text-left max-w-20 font-montserrat">
            ...
            No Picks, Just Data: PickBetta does not
        ...
        <div>
            ...
            <p className="relative ml-5 mt-3 text-gray text-xl font-normal text-left max-w-20 font-montserrat">
            Why PickBetta?
            </p>
            <p className="relative mt-2 ml-5 text-base text-gray text-left max-w-19.4 font-montserrat">
