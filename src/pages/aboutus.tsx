...
export const Aboutus = () => {
  return (
    <div className="about">
      <div>
        <h3 className="relative ss:text-3xl ss:text-dark ss:font-extrabold ss:mt-12 ss:ml-0 ss:max-w-26 ss:text-center sm:text-5xl sm:text-dark sm:font-extrabold sm:mt-11 sm:ml-0 sm:max-w-26 sm:text-center font-montserrat x:text-center x:ml-30 x:mt-14 xl:text-center xl:text-dark-gray-900 xl:text-5xl xl:mt-17 xl:ml-65 xl:font-g xl:max-w-28">
          About Us
        </h3>
        <p className="relative ss:mt-6 ss:ml-4 ss:text-sm ss:text-left ss:max-w-19.3 sm:mt-6 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-8 x:text-center x:max-w-75 xl:text-center xl:max-w-135 xl:ml-16 xl:mt-5">
        ...
        <img
          src={aboutus_image}
          alt=""
          className="relative ss:h-15 ss:mt-6 ss:ml-2 ss:w-20 sm:h-15 sm:mt-6 sm:ml-5 sm:w-20.5 x:ml-33 xl:ml-33 xl:w-90 xl:mt-12.5"
        />
      </div>
      <div>
        <h3 className='x:text-left x:text-3xl x:ml-8 x:mt-8 font-bold'>
          Who We Are
        </h3>
        <h3 className="relative ss:ml-4 ss:mt-6 ss:text-base ss:font-extrabold ss:text-left      sm:ml-5 sm:mt-6 sm:text-xl sm:font-extrabold sm:text-left font-montserrat x:ml-30 x:-mt-6 xl:ml-35 xl:-mt-6">
          The Pain of Paying for Picks
        </h3>
        <p
          className="relative ss:mt-4 ss:ml-4 ss:text-sm ss:text-left ss:max-w-19.3 sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:max-w-100"
        >
      ...
      <div>
        <h3
          className="relative ss:ml-4 ss:mt-5 ss:text-base ss:text-left sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left font-montserrat x:ml-30 xl:ml-35 xl:mt-5 xl:mb-5"
        >
          The Turning Point
        </h3>
        <p
      ...
      <div>
        <h3 className="relative ss:ml-4 ss:mt-5 ss:text-base ss:text-left ss:max-w-20 sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-20 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-100">
          The Problem with Paying for Picks
        </h3>
        <p
          className="relative ss:mt-4 ss:ml-4 ss:text-sm ss:text-left ss:max-w-19.4 sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:max-w-100"
        >
      ...
      <div>
        <h3 className="relative ss:ml-4 ss:mt-5 ss:text-base ss:text-left ss:max-w-20 sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-20 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-25">
      ...
      <div>
        <h3 className="relative  ss:ml-4 ss:mt-6 ss:text-base ss:text-left ss:max-w-21       sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-21 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-25">
          Here’s what drives PickBetta:
        </h3>
        <p
          className="relative  ss:mt-4 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3        sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-100"
        >
      ...
      <div>
        <p
          className="relative  ss:mt-4 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3   sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-100
      ...
      <div>
        <h3 className="relative  ss:ml-4 ss:mt-5 ss:text-base  ss:text-left ss:max-w-20       sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-20 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-7 xl:mb-5 xl:max-w-25">
          The Future of Betting
        </h3>
        <p
          className="relative  ss:mt-4 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3      sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47
        xl:ml-35 xl:max-w-100"
        >
      ...
      <div>
        <h3 className="relative   ss:ml-4 ss:mt-6 ss:text-base ss:text-left ss:max-w-20       sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-20 font-montserrat x:text-3xl x:ml-7 x:max-w-47 xl:text-center xl:text-dark-gray-900 xl:text-4xl xl:mt-10 xl:ml-12 xl:font-g xl:max-w-14 ">
          Mission
        </h3>
        <h3 className="relative  ss:ml-4 ss:mt-6 ss:text-base ss:text-left ss:max-w-21       sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-21 font-montserrat x:-mt-6 x:ml-30 x:max-w-47 xl:ml-35 xl:-mt-6 xl:mb-5 xl:max-w-25">
          Here’s what drives PickBetta:
        </h3>
        <p
          className="relative  ss:mt-4 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3       sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47
      ...
      <div>
        <h3 className="relative  ss:ml-4 ss:mt-5 ss:text-base ss:font-extrabold ss:text-left ss:max-w-20      sm:ml-5 sm:mt-6 sm:text-xl sm:font-extrabold sm:text-left sm:max-w-20 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-25">
          How are we unique?
        </h3>
        <p
          className="relative  ss:mt-4 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3      sm:mt-4 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47
      ...
      <div>
        <h3 className="relative  ss:ml-4 ss:mt-5 ss:text-base  ss:text-left ss:max-w-20     sm:ml-5 sm:mt-6 sm:text-xl font-extrabold sm:text-left sm:max-w-20 font-montserrat x:text-3xl x:ml-7 x:max-w-17 xl:text-left xl:text-dark-gray-900 xl:text-4xl xl:mt-10 xl:ml-12 xl:font-g xl:max-w-20">
          Unique Value Proposition (UVP):
        </h3>
        <p className="relative    ss:ml-4 ss:mt-3  ss:text-base ss:font-normal ss:text-left ss:max-w-20       sm:ml-5 sm:mt-3 text-gray sm:text-xl sm:font-normal sm:text-left sm:max-w-20 font-montserrat x:-mt-11.5 x:ml-30 x:max-w-47 xl:ml-35 xl:max-w-42 xl:-mt-13 xl:text-dark-gray-900 xl:font-extrabold">
          Why PickBetta?
        </p>
        <p className="relative  ss:mt-2 ss:ml-4 ss:text-sm  ss:text-left ss:max-w-19.3     sm:mt-2 sm:ml-5 sm:text-base text-gray sm:text-left sm:max-w-19.4 font-montserrat x:ml-30 x:max-w-47 xl:ml-35 xl:mt-5 xl:mb-5 xl:max-w-100">
          <span className="text-base font-bold text-gray-dark">
      ...
      <div>
        <div>
          <h3 className="relative ss:ml-4 ss:text-dark ss:mt-4 ss:text-base ss:text-left       sm:ml-5 sm:text-dark sm:mt-5 sm:text-xl sm:text-left font-bold x:text-center x:text-2xl x:mt-11 xl:text-dark xl:mt-12 xl:text-3xl xl:text-center">
            Meet the Team
          </h3>
          <p className="relative ss:ml-4 ss:mt-5 ss:text-gray ss:text-sm ss:text-left ss:max-w-19.3        sm:ml-5 sm:mt-5 sm:text-gray sm:text-base sm:text-left sm:max-w-19.4 font-medium x:text-center x:max-w-60 x:ml-17.5 xl:mt-5 xl:ml-50 xl:text-gray xl:text-base xl:text-center xl:max-w-60">
            Just take a look - each member of the team is watching your every
            gesture and will hear your every whisper.
          </p>
        </div>

        <div className=" ss:flex ss:flex-col    sm:flex sm:flex-col x:flex-row x:flex-wrap x:mt-5 xl:flex-row xl:flex-wrap">
          <div className="relative  ss:mt-5 ss:ml-4 ss:h-23 ss:w-19.3 ss:border ss:border-gray ss:bg-transparent     sm:mt-5 sm:ml-7 sm:h-23 sm:w-19.3 sm:border sm:border-gray sm:bg-transparent rounded x:mt-0 x:ml-6.3 xl:mt-7 xl:ml-12">
            <img
              src={amanda}
      ...
      <div>
        <div className="relative ss:ml-5 ss:mt-9 ss:h-19.5 ss:w-19.25 ss:rounded-2xl sm:ml-5 sm:mt-9 sm:h-19.5 sm:w-20.4 bg-green sm:rounded-2xl x:ml-7 x:mt-9 x:h-19.5 x:w-78 x:rounded-3xl xl:ml-12 xl:mt-9 xl:h-19.5 xl:w-144 xl:rounded-3xl">
          <img
            src={faq_styled}
