  ...
  return (
    <div className="relative">
      <div className="md:hidden x:hidden xl:hidden">
        ...
        <div className="fixed ss:mt-3 ss:ml-5 ss:w-19.25 ss:h-7 sm:mt-3 sm:ml-5 sm:w-20.5 sm:h-7 bg-white shadow rounded-3xl z-20">
          <img
            src={logo}
            alt=""
          ...
          <div ref={dropdownRef}>
            <img
              ...
              src={menu_icon}
              alt=""
              className="absolute ss:h-5 ss:mt-2.5 ss:ml-17.5 sm:h-5 sm:mt-2.5 sm:ml-19.5 z-10"
            />
            {open && (
      ...
      <div className="fixed sm-hidden  md:bg-green-light md:w-full md:h-12 md:z-20    x:mt-0 x:bg-green-light x:w-full x:h-12 x:z-20  xl:mt-0 xl:bg-green-light xl:w-full xl:h-12.2 xl:z-20">
        <img
          src={logo}
          alt=""
