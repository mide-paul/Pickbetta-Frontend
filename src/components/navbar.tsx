     ...
     <div className="relative">
      <div className="xl:hidden">
        ...
        <div className="flex xl:gap-7 xl:float-right xl:mr-10.5 xl:mt-7">
          ...
          <Link to="/pricing"><h3 className="relative xl:text-left">Pricing</h3></Link>
          <Link to="/faqs"><h3 className="relative xl:text-left">FAQs</h3></Link>
          <Link to="/signup"><button onClick={() => setOpen(!open)} className="relative p-2 xl:w-12 xl:ml-0 xl:-mt-2 font-medium text-white bg-green rounded font-montserrat">Start Now!</button></Link>
        </div>
        </div>
     </div>
    )
