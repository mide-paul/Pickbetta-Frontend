      ...
      <div className="mobile-footer">
          <div>
            ...
            are responsible for ensuring that their activities comply with applicable laws.
              ...
              <h3 className="relative text-white-light lg:text-sm lg:hover:text-green">Privacy Policy</h3>
              <h3 className="relative text-white-light lg:text-sm lg:hover:text-green">Terms & Conditions</h3>
              </div>
              ...
              <img src={line} alt="" className="absolute h-0.1 mt-19.3 ml-5 sm:h-0.1 sm:mt-19.3 sm:ml-5 lg:mt-19.2 lg:ml-39 w-19.5" />
              ...
              <div>
              <h3 className="absolute mt-20.5 ml-8 sm:mt-20.5 text-white text-sm lg:ml-35 lg:mt-22.5">© 2024 PickBetta. All Rights Reserved</h3>
              </div>
          </div>
         </div>
        </div>
